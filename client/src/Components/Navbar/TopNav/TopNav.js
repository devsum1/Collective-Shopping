    ...
    return (
      <nav className="navbar fixed-top navbar-expand-lg navbar-light Topnavbar">
        ...
        >
          ...
          <Link to="/Cart">
            <i className="fa fa-shopping-bag cart-icon" aria-hidden="true"></i>
          </Link>

          <span className="cart-number">
            {this.props.cartNumber.addToCart.length}
          </span>
        </div>
      </nav>
    );
